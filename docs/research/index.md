...
| Does the public LAMP export support a forecast-sufficient population? | A capped 28-day acquisition retains 1,050,259 rows and 941,984 source headways across every rapid-transit route. Exact active-Schedule identity covers 78.2%; most unresolved rows are added trips. | Advance to a retrospective event-time task. Keep every observed movement, mask Schedule-dependent features where identity is unresolved, and make no online claim. |
