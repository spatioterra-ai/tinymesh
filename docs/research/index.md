...
| What is the retrospective MBTA next-headway floor? | The frozen task retains 940,551 physical targets. On 138,910 validation targets, public plan reaches 152.648 s MAE, a train-only temporal median reaches 157.152 s, and persistence reaches 217.969 s. | Freeze the task and validation-selected temporal control, then open test once before Stage 4. Keep the claim retrospective. |
